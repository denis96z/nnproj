...
TF_LOG_PATH = os.path.join(TF_LOG_DIR, 'chinese', str(TEST_IDX))
KERACT_PATH = os.path.join(KERACT_DIR, 'chinese', str(TEST_IDX))

MODEL_PATH = os.path.join(MODEL_DIR, 'chinese')
